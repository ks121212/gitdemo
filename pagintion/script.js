let datas=[
  ...
  function drawtable(datas){
    ...
    // let thforemail=document.createElement("th");
    // thforemail.innerText="EMAIL";

    // tr.append(thforId,thforname,thforemail);
  ...
  function displayIndexButtons(){
    ...
    $(".index_buttons button").append(`<button>Previous</button>`);
    for(var i=1;i<=max_index;i++){
        $(".index_buttons button").append('<button index="'+i+'">'+i+'</button>');
    }
    $(".index_buttons button").append(`<button>Next</button>`);
